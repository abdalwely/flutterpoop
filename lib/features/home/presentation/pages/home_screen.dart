                ...
                delegate: SliverChildBuilderDelegate(
                  (context, index) {
                    return Padding(
                      ...
                      child: PostWidget(
                        profileImageUrl: 'https://picsum.photos/200?random=${index + 10}',
                        username: 'user_${index + 10}',
                        location: index % 3 == 0 ? 'الرياض، السعودية' : null,
                        timeAgo: '${index + 1}س',
                        imageUrl: 'https://picsum.photos/400?random=${index + 20}',
                        ...
                        onComment: () => _commentOnPost(index),
