...
class _PostWidgetState extends ConsumerState<PostWidget>
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // Post Caption
          if (widget.caption != null) _buildPostCaption(),
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                  image: CachedNetworkImageProvider(widget.profileImageUrl),
                  fit: BoxFit.cover,
                ),
              ),
            ),
          ...
          GestureDetector(
            ...
            child: AnimatedSwitcher(
              ...
              child: Icon(
                ...
                color: widget.isLiked ? AppColors.like : AppColors.textPrimary,
                size: 24.sp,
      ...
      child: Column(
        ...
        children: [
          ...
          if (widget.likesCount > 0)
            Text(
              _formatLikesCount(widget.likesCount),
              style: TextStyle(
                fontSize: 14.sp,
                fontWeight: FontWeight.w600,
                color: AppColors.textPrimary,
  ...
  Widget _buildViewComments() {
    if (widget.commentsCount == 0) return const SizedBox.shrink();
    ...
    return Padding(
      ...
      child: GestureDetector(
        onTap: widget.onComment,
        child: Text(
          'عرض جميع التعليقات (${widget.commentsCount})',
          style: TextStyle(
            fontSize: 14.sp,
            color: AppColors.textSecondary,
            fontFamily: 'Cairo',
