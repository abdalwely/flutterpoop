...
class _CommentsBottomSheetState extends ConsumerState<CommentsBottomSheet> {
  ...
  Widget _buildCommentsList(CommentsState state) {
    ...
    return RefreshIndicator(
      onRefresh: () => ref.read(commentsProvider.notifier).loadComments(
        widget.post.id,
        refresh: true,
      ),
  ...
  Widget _buildLoadMoreButton() {
    ...
    return Padding(
      ...
      child: CustomButton(
        ...
        isOutlined: true,
        onPressed: () => ref.read(commentsProvider.notifier).loadMoreComments(),
      ),
    );
  }
  ...
  Future<void> _submitComment(String userId) async {
    ...
    try {
      await ref.read(commentsProvider.notifier).addComment(
  ...
  Future<void> _likeComment(String commentId) async {
    ...
    try {
      await ref.read(commentsProvider.notifier).likeComment(commentId, user.uid);
    } catch (e) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
  ...
  Future<void> _reportComment(String commentId) async {
    ...
    if (confirmed == true) {
      try {
        await ref.read(commentsProvider.notifier).reportComment(commentId, user.uid);
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
  ...
  Future<void> _deleteComment(String commentId) async {
    ...
    if (confirmed == true) {
      try {
        await ref.read(commentsProvider.notifier).deleteComment(commentId, user.uid);
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
